"undefined" == typeof jwplayer && (jwplayer = function(h) {
        ...
        e.extend = function() {
            var f = Array.prototype.slice.call(arguments,
                0);
            if (1 < f.length) {
                for (var a = f[0], k = function(f, m) { void 0 !== m && null !== m && (a[f] = m) }, m = 1; m < f.length; m++) e.foreach(f[m], k);
                return a
            }
            return null
        };
        ...
        e.saveCookie = function(f, a) { j.cookie = "jwplayer." + f + "\x3d" + a + "; path\x3d/" };
        ...
        e.translateEventResponse = function(f, a) {
            ...
            e.foreach(["position", "duration", "offset"], function(f, m) { k[m] && (k[m] = Math.round(1E3 * k[m]) / 1E3) });
            return k
        };
        ...
        e.repo = function() {
            ...
            try { e.isHTTPS() && (f = f.replace("http://", "https://ssl.")) } catch (a) {}
            return f
        };
        ...
        e.ajax = function(f, a, k, m) {
            ...
            var n = f,
                h = b;
            b.onerror = function() { k("Error loading file", n, h) };
            try { b.open("GET", f, !0) } catch (G) {
                d = !0
            }
            setTimeout(function() {
                if (d) k && k(f, f, b);
                else try { b.send() } catch (a) { k && k(f, f, b) }
            }, 0);
            return b
        };
        ...
        e.addClass = function(a, b) { a.className = a.className + " " + b };
        e.removeClass = function(a, b) { a.className = a.className.replace(RegExp(" *" + b, "g"), " ") }
    }(jwplayer), function(h) {
        function c(a) {
            var b =
        ...
        b.cssKeyframes = function(a, b) {
            ...
            var d = d.sheet,
                f = "@keyframes " + a + " { " + b + " }";
            try { d.insertRule(f, d.cssRules.length) } catch (g) {}
            f = f.replace(/(keyframes|transform)/g, "-webkit-$1");
            try { d.insertRule(f, d.cssRules.length) } catch (j) {}
        };
        ...
        q.block = function(a) { null === d && (d = { id: a, styleSheets: {}, elements: [] }) };
        ...
        b.dragStyle = function(a, b) { q(a, { "-webkit-user-select": b, "-moz-user-select": b, "-ms-user-select": b, "-webkit-user-drag": b, "user-select": b, "user-drag": b }) };
        ...
        b.rotate = function(a, d) { b.transform(a, "rotate(" + d + "deg)") };
        b.rgbHex = function(a) {
            a = String(a).replace("#", "");
        ...
        var c = h.foreach,
            ...
            j = { mp4: l.mp4, f4v: l.mp4, m4v: l.mp4, mov: l.mp4, m4a: l.aac, f4a: l.aac, aac: l.aac, mp3: l.mp3, ogv: l.ogg, ogg: l.ogg, oga: l.vorbis, vorbis: l.vorbis, webm: l.webm, m3u8: l.hls, m3u: l.hls, hls: l.hls },
            g = h.extensionmap = {};
        c(j, function(b, c) { g[b] = { html5: c } });
        c({
            flv: "video",
            f4v: "video",
            mov: "video",
        ...
        h.touch = function(j) {
            ...
            function e(a, b) {
                ...
                var c = n.getBoundingClientRect(),
                    d = { type: a, target: n, x: d.pageX - window.pageXOffset - c.left, y: d.pageY, deltaX: 0, deltaY: 0 };
                a !=
            ...
            this.addEventListener = function(a, b) { d[a] = b };
            this.removeEventListener = function(a) { delete d[a] };
            return this
        }
    }(jwplayer.utils),
    function(h) {
    ...
    function(h) {
        ...
        h.events.eventdispatcher = function(l, j) {
            ...
            this.addEventListener = function(e, a, d) {
                try { c.exists(b[e]) || (b[e] = []), "string" == c.typeOf(a) && (a = (new Function("return " + a))()), b[e].push({ listener: a, count: d || null }) } catch (f) { c.log("error", f) }
                return !1
            };
            ...
            this.addGlobalListener = function(b, a) {
                try { "string" == c.typeOf(b) && (b = (new Function("return " + b))()), e.push({ listener: b, count: a || null }) } catch (d) { c.log("error", d) }
                return !1
            };
        ...
        h.plugins.pluginloader = function(g, b) {
            ...
            this.setupPlugins = function(a, b, d) {
                ...
                j(b.plugins, function(g, j) {
                    ...
                    } catch (P) { c.log("ERROR: Failed to load " + k + ".") }
                });
                a.plugins = m;
                return e
            };
            this.load = function() {
                if (!(c.exists(b) && "object" != c.typeOf(b))) {
                    ...
                    j(b,
                        function(a) { c.exists(a) && (a = g.addPlugin(a), a.addEventListener(l.COMPLETE, h), a.addEventListener(l.ERROR, r)) });
                    var d = g.getPlugins();
                    j(d, function(a, b) { b.load() })
                }
                h()
            };
            this.destroy = function() { m && (m.resetEventListeners(), m = null) };
            var r = this.pluginFailed = function() { f || (f = !0, q = "File not found", e()) };
            this.getStatus = function() {
                return a
            }
        }
    ...
    function(h) {
        ...
        h.loader = function() {
            ...
            function c(a) { n(a.match(/invalid/i) ? "Not a valid RSS feed" : "") }

            function n(b) { a.sendEvent(j.JWPLAYER_ERROR, { message: b ? b : "Error loading file" }) }
            var a = new j.eventdispatcher;
            l.extend(this, a);
            this.load = function(a) { l.ajax(a, b, c) }
        }
    }(jwplayer.playlist),
    function(h) {
        var c = jwplayer.utils,
        ...
        h.source = function(j) {
            var g = c.extend({}, l);
            c.foreach(l, function(b) { c.exists(j[b]) && (g[b] = j[b], delete j[b]) });
    ...
    function(h) {
        ...
        c.adprovider = function(j, g) {
            function b() { f = { message: q, position: 0, duration: -1 } }

            function e(a, b) {
                var d = { command: a };
                void 0 !== b && (d.args = b);
                g.sendMessage(j, d, n, function(a) { c.error("message send error", a) })
            }
            ...
            d.skipAd = function(a) { e("skipAd", { tag: a.tag }) };
    ...
    function(h, c) {
        function l(a, b) { a[b] && (a[b] = g.getAbsolutePath(a[b])) }
        var j = c.cast,
            g = c.utils,
            b = c.events,
            e = b.state,
        ...
        j.controller = function(a, d) {
            ...
            function k(a, b) {
                var d = { command: a };
                void 0 !== b && (d.args = b);
                w.sendMessage(j.NS, d, O, function(a) { j.log("error message", a); "Invalid namespace" === a.description && A() })
            }
            ...
            function v(m) {
                ...
                z.init();
                d.setVideo(z);
                a.jwPlay = function(a) {!1 === a ? z.pause() : z.play() };
                ...
                a.jwPlaylistNext = function() { a.jwPlaylistItem(d.item + 1) };
                a.jwPlaylistPrev = function() { a.jwPlaylistItem(d.item - 1) };
                ...
                a.jwSkipAd = function(a) { y && (y.skipAd(a), a = y.getAdModel(), a.complete = !0, d.sendEvent(b.JWPLAYER_CAST_AD_CHANGED, a)) };
            ...
            function C(a) {
                ...
                a ? I() : (z.sendEvent(b.JWPLAYER_PLAYER_STATE, { oldstate: d.state, newstate: e.BUFFERING }), F())
            }
            ...
            function F() {
                ...
                if (M) {
                    ...
                    z && (z.destroy(), z = null);
                    y && (y.destroy(), y = null);
                    d.state !== e.IDLE ? g.isIPad() || g.isIPod() ? (a.jwStop(!0), M.sendEvent(b.JWPLAYER_PLAYER_STATE, { oldstate: e.BUFFERING, newstate: e.IDLE })) : (d.state = e.IDLE, a.jwPlay(!0), a.jwSeek(d.position)) : M.sendEvent(b.JWPLAYER_PLAYER_STATE, {
            ...
            this.startCasting = function() { w || a.jwInstreamState() || h.chrome.cast.requestSession(v, p) };
            this.stopCasting = A
        };
        j.log = function() {
            if (j.debug) {
    ...
    function(h, c) {
        function l() { c && c.cast && c.cast.isAvailable && !a.apiConfig ? (a.apiConfig = new c.cast.ApiConfig(new c.cast.SessionRequest(m), e, n, c.cast.AutoJoinPolicy.ORIGIN_SCOPED), c.cast.initialize(a.apiConfig, b, g)) : 15 > k++ && setTimeout(l, 1E3) }

        function j() { q && (q.resetEventListeners(), q = null) }

        function g() { a.apiConfig = null }
    ...
    function(h) {
        ...
        j.provider = function(h) {
            ...
            var d = g.extend(this, new b.eventdispatcher("cast.provider")),
                f = -1,
                q = { newstate: e.IDLE, oldstate: e.IDLE, buffer: 0, position: 0, duration: -1, audioMode: !1 };
            d.isCaster = !0;
            d.init = function() {};
            d.destroy = function() {
                clearTimeout(f);
            ...
            d.sendCommand = function(a, b) { h(a, b) };
            d.detachMedia = function() {
                j.error("detachMedia called while casting");
                return document.createElement("video")
            };
            d.attachMedia = function() { j.error("attachMedia called while casting") };
            var k;
            d.setContainer = function(a) { k = a };
            ...
            a = h.embed = function(d) {
                function f() {
                    if (!B)
                        ...
                        var p;
                        u.fallback ? (p = "No suitable players found and fallback enabled", D = setTimeout(function() { r(p, b) }, 10), j.log(p), new a.download(E, u, m)) : (p = "No suitable players found and fallback disabled", r(p, e), j.log(p), E.parentNode.replaceChild(H, E))
                    }
                }

                function q(a) { x(A + a.message) }

                function k(a) { d.dispatchEvent(g.JWPLAYER_ERROR, { message: "Could not load plugin: " + a.message }) }

                function m(a) { a && a.message ? x("Error loading playlist: " + a.message) : x(A + "No playable sources found") }
                ...
                function x(a) { B || (u.fallback ? (B = b, l(E, a, u), r(a, b)) : r(a, e)) }
                ...
                this.embed = function() { B || (v.addEventListener(g.COMPLETE, f), v.addEventListener(g.ERROR, k), v.load()) };
    ...
    function(h) {
        ...
        h.embed.download = function(j, g, b) {
            function e(a, b) {
                for (var d = l.querySelectorAll(a), e = 0; e < d.length; e++) c.foreach(b, function(a, b) { d[e].style[a] = b })
            }
            ...
            if (a && a.length) {
                ...
                for (a = 0; a < q.length; a++) {
                    ...
                    t.file && c.foreach(u, function(a) { p == u[a] ? (k = t.file, m = x.image) : c.isYouTube(t.file) && (r = t.file) })
                }
        ...
        (h.embed.flash = function(b, e, n, a, d) {
            ...
            function k(a) {
                ...
                c.foreach(a, function(a, e) {
                    ...
                    d.push(a);
                    c.foreach(e, function(a, c) { b[f + "." + a] = c })
                });
                b.plugins = d.join(",");
                return b
            }
            ...
            this.embed = function() {
                ...
                h = c.getCookies();
                c.foreach(h, function(a, b) { "undefined" == typeof p[a] && (p[a] = b) });
    ...
    function(h) {
        ...
        h.embed.html5 = function(b, e, j, a, d) {
            function f(a, c, d) {
                return function() {
                    try {
                        ...
                        d && e.appendChild(c);
                        "function" == typeof a.resize && (a.resize(e.clientWidth, e.clientHeight), setTimeout(function() { a.resize(e.clientWidth, e.clientHeight) }, 400));
                        c.left = e.style.left;
                        c.top = e.style.top
                    } catch (f) {}
                }
            ...
            function q(a) { k.sendEvent(a.type, { message: "HTML5 player not found" }) }
            var k = this,
    ...
    function(h) {
        ...
        h.embed = l.extend(function(g) {
            function b() { t = "Adobe SiteCatalyst Error: Could not find Media Module" }
            var e = l.repo(),
    ...
    function(h) {
        ...
        h.sitecatalyst = function(h) {
            ...
            function e() { r || (b(), r = !0, j("close: " + f), s.Media.close(f), x = !0, k = 0) }
            var n = h,
                ...
                r = !0,
                x;
            c.foreach(d, function(a) { n[a](d[a]) })
        }
    }(jwplayer.embed),
    function(h, c) {
        var l = [],
        ...
        h.api = function(l) {
            ...
            function x(a, b) {
                try { a.jwAddEventListener(b, 'function(dat) { jwplayer("' + p.id + '").dispatchEvent("' + b + '", dat); }') } catch (c) { j.log("Could not add internal listener") }
            }
            ...
            p.addButton =
                function(a, b, c, d) {
                    try { E[d] = c, t("jwDockAddButton", a, b, "jwplayer('" + p.id + "').callback('" + d + "')", d) } catch (e) { j.log("Could not add dock button" + e.message) }
                };
            p.removeButton = function(a) { t("jwDockRemoveButton", a) };
            ...
            p.destroyPlayer = function() { t("jwPlayerDestroy") };
            p.playAd = function(a) {
            ...
            k(d, u);
            j.foreach(n, function(a, b) { m(!1, b) });
            j.foreach(a, function(a, b) { m(!0, b) });
            p.remove = function() {
                if (!C) throw "Cannot call remove() before player is ready";
                r(this)
            };
            p.registerPlugin = function(a, b, c, d) { h.plugins.registerPlugin(a, b, c, d) };
            ...
            p.dispatchEvent = function(a, b) {
                ...
                if (c)
                    for (var c = c.slice(0), d = j.translateEventResponse(a, b), e = 0; e < c.length; e++) {
                        var f =
                            c[e];
                        if ("function" === typeof f) try { a === g.JWPLAYER_PLAYLIST_LOADED && j.deepReplaceKeyName(d.playlist, ["__dot__", "__spc__", "__dsh__", "__default__"], [".", " ", "-", "default"]), f.call(this, d) } catch (h) { j.log("There was an error calling back an event handler") }
                    }
            };
            p.dispatchInstreamEvent = function(a) { B && B.dispatchEvent(a, arguments) };
            p.callInternal = t;
            p.playerReady = function(a) {
                C = !0;
                v || p.setPlayer(e.getElementById(a.id));
                p.container = e.getElementById(p.id);
                j.foreach(A, function(a) { x(v, a) });
                u(g.JWPLAYER_PLAYLIST_ITEM,
                    function() { H = {} });
                u(g.JWPLAYER_MEDIA_META, function(a) { j.extend(H, a.metadata) });
        ...
        h.api.destroyPlayer = function(a) {
            var b, d, f;
            j.foreach(l, function(c, e) { e.id === a && (b = c, d = e) });
    ...
    function(h) {
        ...
        h.api.instream = function(g, b) {
            ...
            k.play = function(a) { b.jwInstreamPlay(a) };
            k.pause = function(a) { b.jwInstreamPause(a) };
            k.hide = function() { g.callInternal("jwInstreamHide") };
            k.destroy = function() {
                k.removeEvents();
                g.callInternal("jwInstreamDestroy")
            };
            k.setText = function(a) { b.jwInstreamSetText(a ? a : "") };
            k.getState = function() {
                return b.jwInstreamState()
            };
            k.setClick = function(a) { b.jwInstreamClick && b.jwInstreamClick(a) }
        }
    }(window.jwplayer),
    function(h) {
        var c = h.api,
        ...
        c.selectPlayer = function(c) {
            return (c = l(c)) ? c : { registerPlugin: function(c, b, e) { h.plugins.registerPlugin(c, b, e) } }
        }
    }(jwplayer));

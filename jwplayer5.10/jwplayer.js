if (typeof jwplayer == "undefined") {
    ...
    (function(b) {
        ...
        b.api.destroyPlayer = function(h, d) {
            ...
            if (g >= 0) {
                try { a[g].callInternal("jwDestroy") } catch (k) {}
    ...
    (function(a) {
        ...
        a.html5.view = function(n, H, h) {
            ...
            function p(U) {
                ...
                switch (U.newstate) {
                    case a.api.events.state.PLAYING:
                        if (j.getMedia() && j.getMedia().hasChrome()) { o.style.display = "none" }
                        break;
                    default:
            ...
            function v(V) {
                ...
                if (d.exists(X)) {
                    if (O != X) {
                        if (O && O.parentNode) { O.parentNode.replaceChild(X, O) }
                        O = X
                    }
                    for (var U = 0; U < j.plugins.order.length; U++) {
            ...
            this.setup = function() {
                if (j && j.getMedia()) { y = j.getMedia().getDisplayElement() }
                L();
                K();
            ...
            function M(U) {
                switch (U.keyCode) {
                    case 27:
                        if (m.jwGetFullscreen()) { m.jwSetFullscreen(false) }
                        break;
                    case 32:
                        if (m.jwGetState() != a.api.events.state.IDLE && m.jwGetState() != a.api.events.state.PAUSED) { m.jwPause() } else { m.jwPlay() }
                        break
                }
            }
            ...
            function G(U, ad) {
                ...
                if (x && B()) {
                    try {
                        if (j.fullscreen && !j.getMedia().getDisplayElement().webkitDisplayingFullscreen) { j.fullscreen = false }
                    } catch (aa) {}
                }
                if (!j.fullscreen) {
                    g = U;
                    t = ad;
                    if (typeof U == "string" && U.indexOf("%") > 0) { g = d.getElementWidth(d.parentNode(R)) * parseInt(U.replace("%"), "") / 100 } else { g = U }
                    if (typeof ad == "string" && ad.indexOf("%") > 0) { t = d.getElementHeight(d.parentNode(R)) * parseInt(ad.replace("%"), "") / 100 } else { t = ad }
                    var Y = { top: 0, bottom: 0, left: 0, right: 0, width: g, height: t, position: "absolute" };
                    b(o, Y);
                    var ae = {};
                    var ab;
                    try { ab = j.plugins.object.display.getDisplayElement() } catch (aa) {}
                    if (ab) {
            ...
            function I(V, W) {
                if (d.exists(j.plugins.object[V].getDisplayElement)) {
                    if (j.plugins.config[V].position && T(j.plugins.config[V].position)) {
                        if (!d.exists(j.plugins.object[V].getDisplayElement().parentNode)) { R.appendChild(j.plugins.object[V].getDisplayElement()) }
                        var U = z(V);
                        U.zIndex = W;
                        return U
                    }
            ...
            function q(U, V) {
                if (!d.exists(j.plugins.object[U].getDisplayElement().parentNode)) { o.appendChild(j.plugins.object[U].getDisplayElement()) }
            ...
            var l = this.resizeMedia = function() {
                ...
                if (W && W.tagName.toLowerCase() == "video") {
                    ...
                    if (j.fullscreen && m.jwGetStretching() == a.utils.stretching.EXACTFIT && !d.isMobile()) {
                        ...
                        if (!c) { d.stretch(m.jwGetStretching(), W, d.getElementWidth(o), d.getElementHeight(o), W.videoWidth ? W.videoWidth : 400, W.videoHeight ? W.videoHeight : 300) }
                    }
                } else {
            ...
            var C = this.fullscreen = function(W) {
                ...
                var Y;
                try { Y = j.getMedia().getDisplayElement() } catch (X) {}
                if (W) {
                    k = j.width;
                    Q = j.height
                }
                    ...
                    if (W && !Y.webkitDisplayingFullscreen) {
                        ...
                        if (!W) {
                            ...
                            if (Y.webkitDisplayingFullscreen) {
                                try { Y.webkitExitFullscreen() } catch (V) {}
                            }
                            o.style.display = J
                        }
                    }
    ...
    (function(a) {
        ...
        a.html5.controlbar = function(m, Y) {
            ...
            function N() {
                if (l.jwGetHeight() <= 40) {
                    ...
                    for (var an = 0; an < D.layout.left.elements.length; an++) {
                        if (D.layout.left.elements[an].name == "fullscreen") { D.layout.left.elements.splice(an, 1) }
                    }
                    for (an = 0; an < D.layout.right.elements.length; an++) {
                        if (D.layout.right.elements[an].name == "fullscreen") { D.layout.right.elements.splice(an, 1) }
                    }
                    o()
                }
                am(D.layout.left);
            ...
            function am(aq, an) {
                ...
                for (var ao = 0; ao < ap.length; ao++) { C(ap[ao], ar, aq) }
            }
                ...
                if (_utils.exists(l.skin.getSkinElement("controlbar", aq)) || aq.indexOf("Text") > 0 || aq.indexOf("divider") === 0) {
                    ...
                    if (aq.indexOf("Text") > 0) {
                        ...
                        if (aq.indexOf("divider") === 0) {
                            if (an) {
                                if (!isNaN(parseInt(an))) { ay = parseInt(an) }
                            } else {
                                if (ap) {
                ...
                if (_utils.exists(l.skin.getSkinElement("controlbar", ap))) {
                    ...
                    if (_utils.exists(an)) {
                        ...
                        if (aq == "fullscreen") {
                            ...
                            an.onmouseup = function(ar) {
                                ar.stopPropagation();
                                if (_utils.exists(ao)) { l[aq](ao) } else { l[aq]() }
                            }
                        }
                    }
                }
            ...
            function v(ao) {
                if (_utils.exists(ao.bufferPercent)) { g = ao.bufferPercent }
                if (c.timeSliderRail) {
            ...
            function J(at) {
                if (_utils.exists(at.position)) { k = at.position }
                var ao = false;
                ...
                if (av) {
                    ...
                    if (S.timeSliderProgress) {
                        ...
                        if (!h) {
                            if (S.timeSliderThumb) { S.timeSliderThumb.style.left = ar + "px" }
                        }
                    }
                }
            ...
            function o() {
                ...
                for (var ap = 0; ap < an.length; ap++) {
                    ...
                    for (var ao in ar) {
                        ...
                        if (ar[ao].id.indexOf(ag.id + "_divider") === 0 && aq && aq.id.indexOf(ag.id + "_divider") === 0 && ar[ao].style.backgroundImage == aq.style.backgroundImage) { ar[ao].style.display = "none" } else {
                            if (ar[ao].id.indexOf(ag.id + "_divider") === 0 && at && at.style.display != "none") { ar[ao].style.display = "block" }
                        }
    ...
    (function(b) {
        ...
        b.html5.controller = function(o, K, f, h) {
            ...
            this.destroy = function() {
                if (m.getMedia()) { m.getMedia().destroy() }
            }
        }
    })(jwplayer);
    (function(a) {
        ...
        b.html5.mediavideo = function(k, I) {
            ...
            this.load = function(Y, Z) {
                ...
                if (Y.levels && Y.levels.length > 0) {
                    if (Y.levels.length == 1 || f.isIOS()) { o.src = Y.levels[0].file } else {
                        if (o.src) { o.removeAttribute("src") }
            ...
            this.play = function() {
                ...
                C();
                if (J) { y(b.api.events.state.PLAYING) } else {
                    o.load();
                    y(b.api.events.state.BUFFERING)
                }
                o.play()
            ...
            var B = this.stop = function(X) {
                ...
                if (X) {
                    ...
                    if (o.webkitSupportsFullscreen) {
                        try { o.webkitExitFullscreen() } catch (Z) {}
                    }
                    o.style.opacity = 0;
                    x();
                ...
                if (f.isIPod()) {
                    ...
                    if (f.isIPad()) {
                        o.style.display = "none";
                        try { o.webkitExitFullscreen() } catch (aa) {}
                    }
                }
                y(b.api.events.state.IDLE)
            };
            this.fullscreen = function(X) {
                if (X === true) { this.resize("100%", "100%") } else { this.resize(l.config.width, l.config.height) }
            };
            ...
            function K(Y, X) {
                if (E[Y]) {
                    ...
                    E[Y] = function(Z) {
                        if (f.exists(Z.target.parentNode)) { X(Z) }
                    };
                    return E[Y]
                }
            }
            ...
            function p() {
                var X = c[l.id];
                if (!X) {
                    if (D.tagName.toLowerCase() == "video") { X = D } else { X = document.createElement("video") }
                    c[l.id] = X;
                    if (!X.id) { X.id = D.id }
                }
            ...
            function G(Z) {
                ...
                var Y;
                if (f.exists(Z) && Z.lengthComputable && Z.total) { Y = Z.loaded / Z.total * 100 } else {
                ...
                if (f.useNativeFullscreen() && f.exists(o.webkitDisplayingFullscreen)) {
                    if (l.fullscreen != o.webkitDisplayingFullscreen) { u(b.api.events.JWPLAYER_FULLSCREEN, { fullscreen: o.webkitDisplayingFullscreen }, true) }
                }
                ...
                if (f.exists(Y) && f.exists(Y.target)) {
                    if (z > 0) {
                        if (!isNaN(Y.target.duration) && (isNaN(l.duration) || l.duration < 1)) {
                            if (Y.target.duration == Infinity) { l.duration = 0 } else { l.duration = Math.round(Y.target.duration * 10) / 10 }
                        }
                    }
            ...
            function r(X) {
                ...
                if (d[X.type]) {
                    if (X.type == "ended") { R() } else { y(d[X.type]) }
                }
            }
            ...
            function w(Y) {
                ...
                if (!z) {
                    if ((l.duration < X || isNaN(l.duration)) && o.duration != Infinity) { l.duration = X }
                }
            ...
            function C() {
                if (!f.exists(H)) { H = setInterval(function() { G() }, 100) }
            }
            ...
            function m(X) {
                if (f.exists(o.webkitDisplayingFullscreen)) {
                    if (l.fullscreen && !o.webkitDisplayingFullscreen) { u(b.api.events.JWPLAYER_FULLSCREEN, { fullscreen: false }, true) }
                }
            }
            ...
            function u(X, Z, Y) {
                if (v || Y) {
                    if (Z) { N.sendEvent(X, Z) } else { N.sendEvent(X) }
                }
            }
        }
    })(jwplayer);
